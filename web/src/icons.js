...
export const ICON = {
  ...
  expand:  svg('<path d="M7.5 3.8H3.8v3.7M12.5 3.8h3.7v3.7M7.5 16.2H3.8v-3.7M12.5 16.2h3.7v-3.7"/>'),
  collapse: svg('<path d="M3.8 7.5h3.7V3.8M16.2 7.5h-3.7V3.8M3.8 12.5h3.7v3.7M16.2 12.5h-3.7v3.7"/>'),
